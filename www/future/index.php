...
<?
    ...
    $url = $apiprefix."/msp/scheduled_scans.php?type=scan&active=yes";
    $error = "";
    $aryData = array();
        ...
        function tag($name, $attrs, $children) {
            ...
            if($currenttag=="NEXTLAUNCH_UTC") {
               ...
               if(trim($name)!=""&&trim($name)!="DEFAULT_SCANNER") {
                $timestamp = strtotime($name." GMT");
		$aryData[$i][0] = $timestamp;
//                $aryData[$i][0] = date("m-d h:i:s a", $timestamp);
...
<p align=center>
	<table id=datatable width=1200>
		<tr>
			...
			<th width=100><img src="../images/type.png" alt="Type"></th>
			<th width=350><img src="../images/profile.png" alt="Profile"></th>
